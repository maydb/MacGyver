...
class Mac_Gyver:
    def __init__(self, level_file):
        ...
        self.inventory = "This is your inventory, you need to craft a seringue in order to pass the guardian!"
        ...
        self.label2 = Label(self.window, text=self.inventory, bg="red")
        self.label2.pack()
    ...
    def what_treasurs(self, treasure_id):
        if treasure_id == self.treasure1:
            ...
            self.infos = "Congratulations ! You found a small plastic tube !"
        elif treasure_id == self.treasure3:
            self.infos = "Congratulations ! You found ether !"
    ...
    def how_many_treasurs(self):
        ...
        if self.treasurs[0] == 0:
            self.label2 = Label(self.window, text=treasure1_sent, bg="red")
            self.label2.pack()
        if self.treasurs[1] == 0:
            self.label2 = Label(self.window, text=treasure2_sent, bg="red")
            self.label2.pack()
        if self.treasurs[2] == 0:
            self.label2 = Label(self.window, text=treasure3_sent, bg="red")
            self.label2.pack()
        elif self.treasurs[0] == 1 and self.treasurs[1] == 2 and self.treasurs[2] == 3:
            self.label2 = Label(self.window, text=all_treasurs_sent, bg="red")
            self.label2.pack()
